...
class Task(models.Model):
    ...
    # detailed_description = models.TextField(max_length=3000, null=False, blank=False, verbose_name='detailed_description')
    create_until = models.DateField(auto_now_add=True, verbose_name='Create_until')
    status = models.CharField(max_length=50, null=False, blank=False, default='new', choices=STATUS_CHOICES)
